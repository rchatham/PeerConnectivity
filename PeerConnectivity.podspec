#
#  Be sure to run `pod spec lint PeerConnectivity.podspec' to ensure this is a
...
and configure your event handling and you are ready to go.
  ...
  # Or just: s.author    = "rchatham"
  # s.authors            = { "rchatham" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/rchatham"
